...
static void atf_ci::citest_LoadStatic() {
    static struct _t {
        ...
        { "atfdb.citest  citest:checkclean  cijob:normalize  sandbox:N  skip:N  comment:\"Check that no files are modified\"", atf_ci::citest_checkclean }
        ,{ "atfdb.citest  citest:atf_amc  cijob:comp  sandbox:N  skip:N  comment:\"Test amc (run atf_amc)\"", atf_ci::citest_atf_amc }
        ,{ "atfdb.citest  citest:gitfile  cijob:normalize  sandbox:N  skip:N  comment:\"Update gitfile tables by scanning filesystem\"", atf_ci::citest_gitfile }
        ,{ "atfdb.citest  citest:scanreadme  cijob:normalize  sandbox:N  skip:N  comment:\"Update readme tables by scanning filesystem\"", atf_ci::citest_scanreadme }
        ,{ "atfdb.citest  citest:ssimfile  cijob:normalize  sandbox:N  skip:N  comment:\"Check for .ssim files with no corresponding ssimfile entry\"", atf_ci::citest_ssimfile }
        ,{ "atfdb.citest  citest:normalize_acr  cijob:normalize  sandbox:N  skip:N  comment:\"Read ssim databases into memory and write back\"", atf_ci::citest_normalize_acr }
        ,{ "atfdb.citest  citest:src_lim  cijob:normalize  sandbox:N  skip:N  comment:\"Source code police\"", atf_ci::citest_src_lim }
        ,{ "atfdb.citest  citest:amc  cijob:normalize  sandbox:N  skip:N  comment:\"Run amc\"", atf_ci::citest_amc }
        ,{ "atfdb.citest  citest:bootstrap  cijob:normalize  sandbox:N  skip:N  comment:\"Re-generate bootstrap files\"", atf_ci::citest_bootstrap }
        ,{ "atfdb.citest  citest:shebang  cijob:normalize  sandbox:N  skip:N  comment:\"\"", atf_ci::citest_shebang }
        ,{ "atfdb.citest  citest:encoding  cijob:normalize  sandbox:N  skip:N  comment:\"Check Encoding of h/cpp files\"", atf_ci::citest_encoding }
        ,{ "atfdb.citest  citest:readme  cijob:normalize  sandbox:N  skip:Y  comment:\"Re-generate readme files\"", atf_ci::citest_readme }
        ,{ "atfdb.citest  citest:file_header  cijob:normalize  sandbox:N  skip:N  comment:\"Update headers in source files\"", atf_ci::citest_file_header }
        ,{ "atfdb.citest  citest:non-copyrighted  cijob:normalize  sandbox:N  skip:N  comment:\"Find non-copyrighted files\"", atf_ci::citest_non_copyrighted }
        ,{ "atfdb.citest  citest:iffy_src  cijob:normalize  sandbox:N  skip:N  comment:\"Check for iffy source constructs with src_func\"", atf_ci::citest_iffy_src }
        ,{ "atfdb.citest  citest:stray_gen  cijob:normalize  sandbox:N  skip:N  comment:\"*/gen/* file that doesn't appear to be generated by amc\"", atf_ci::citest_stray_gen }
        ,{ "atfdb.citest  citest:tempcode  cijob:normalize  sandbox:N  skip:N  comment:\"Check for temp code inserted for testing only\"", atf_ci::citest_tempcode }
        ,{ "atfdb.citest  citest:lineendings  cijob:normalize  sandbox:N  skip:N  comment:\"Correct windows-style line endings in known text files\"", atf_ci::citest_lineendings }
        ,{ "atfdb.citest  citest:indent_script  cijob:normalize  sandbox:N  skip:N  comment:\"Indent any bash script file\"", atf_ci::citest_indent_script }
        ,{ "atfdb.citest  citest:comptest  cijob:comp  sandbox:N  skip:N  comment:\"Rewrite/normalize component tests\"", atf_ci::citest_comptest }
        ,{ "atfdb.citest  citest:cppcheck  cijob:normalize  sandbox:N  skip:N  comment:\"Cppcheck static code analysis\"", atf_ci::citest_cppcheck }
        ,{ "atfdb.citest  citest:bintests  cijob:comp  sandbox:N  skip:N  comment:\"Run bin/test-* scripts\"", atf_ci::citest_bintests }
        ,{ "atfdb.citest  citest:indent_srcfile  cijob:normalize  sandbox:N  skip:N  comment:\"Indent any source files modified in last commit\"", atf_ci::citest_indent_srcfile }
        ,{ "atfdb.citest  citest:normalize_amc_vis  cijob:normalize  sandbox:N  skip:N  comment:\"Check that amc_vis doesn't see any circular dependencies\"", atf_ci::citest_normalize_amc_vis }
        ,{ "atfdb.citest  citest:normalize_acr_my  cijob:normalize  sandbox:N  skip:N  comment:\"Round trip ssim databases through MariaDB and back\"", atf_ci::citest_normalize_acr_my }
        ,{ "atfdb.citest  citest:apm_check  cijob:normalize  sandbox:N  skip:N  comment:\"\"", atf_ci::citest_apm_check }
        ,{ "atfdb.citest  citest:atf_unit  cijob:comp  sandbox:N  skip:N  comment:\"Run unit tests\"", atf_ci::citest_atf_unit }
        ,{ "atfdb.citest  citest:atf_comp  cijob:comp  sandbox:N  skip:N  comment:\"Run component tests\"", atf_ci::citest_atf_comp }
        ,{ "atfdb.citest  citest:atf_comp_cov  cijob:comp  sandbox:N  skip:N  comment:\"Check component test coverage\"", atf_ci::citest_atf_comp_cov }
        ,{ "atfdb.citest  citest:apm  cijob:comp  sandbox:Y  skip:N  comment:\"Test APM\"", atf_ci::citest_apm }
        ,{ "atfdb.citest  citest:atf_comp_mem  cijob:memcheck  sandbox:N  skip:N  comment:\"Run component tests in memcheck mode (slow)\"", atf_ci::citest_atf_comp_mem }
        ,{ "atfdb.citest  citest:acr_ed_ssimfile  cijob:comp  sandbox:Y  skip:N  comment:\"Create a new ssimfile\"", atf_ci::citest_acr_ed_ssimfile }
        ,{ "atfdb.citest  citest:acr_ed_ssimdb  cijob:comp  sandbox:Y  skip:N  comment:\"Create a new ssimdb\"", atf_ci::citest_acr_ed_ssimdb }
        ,{ "atfdb.citest  citest:apm_reinstall  cijob:comp  sandbox:Y  skip:N  comment:\"Check that packages are removable\"", atf_ci::citest_apm_reinstall }
        ,{ "atfdb.citest  citest:acr_ed_target  cijob:comp  sandbox:Y  skip:N  comment:\"Takes a while - do it last\"", atf_ci::citest_acr_ed_target }
        ,{NULL, NULL}
    };
    (void)data;
    atfdb::Citest citest;
